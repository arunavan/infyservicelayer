...
public class UserInterface {
 ...
 AnnotationConfigApplicationContext(SpringConfig.class); 
		...
		Student s=(Student)applicationContext.getBean(Student.class);//DI- IOC
		s.disp();
		...
		//DI - IOC   - getBean
		 ...
		 System.out.println(welcomeBean2.printWelcome() +"  "+welcomeBean2);
		  ...
		  Course c1=(Course)applicationContext.getBean(Course.class); 
		 Course c2=(Course)applicationContext.getBean(Course.class);
		 Course c3=(Course)applicationContext.getBean(Course.class);
		 
		  System.out.println(c1.getCourse() +"  address:"+c1
		  +"  hachcode"+c1.hashCode()); 
		  System.out.println(c2+"   address: hachcode"+c2.hashCode());
		  System.out.println(c3.getCourse() +"  address:"+c3
				  +"  hachcode"+c3.hashCode()); 
